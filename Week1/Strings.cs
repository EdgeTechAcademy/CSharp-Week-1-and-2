...
namespace Week1
{
    class Strings
    {
        ...
        private static void FunWithStrings()
        {
            ...
            Console.WriteLine("Look Ma! No 'e's! " + name.Replace("e", "xxxx", StringComparison.CurrentCultureIgnoreCase));
